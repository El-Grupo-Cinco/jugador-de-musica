  ...
  return (
    <ScrollView contentContainerStyle={styles.main}>
      <View style={styles.suggestionsContainer}>
        <ThemedText style={styles.suggestionsTitle}>🎧 About The SoundPlayer</ThemedText>

        <ThemedText style={styles.introText}>
          Welcome to <ThemedText type="title">The SoundPlayer</ThemedText> —
        ...
        <ThemedText style={styles.introText}>
          👨‍🚀 <ThemedText type="title">Domingos</ThemedText> — The visionary
          behind the groove. He dreams in beats, codes in melodies, and somehow
          makes the impossible sound smooth.
        </ThemedText>

        <ThemedText style={styles.introText}>
          🧠 <ThemedText type="title">Ninis</ThemedText> — The code architect.
          If something runs fast, clean, and bug-free, you can bet Ninis had
          something to do with it.
        </ThemedText>

        <ThemedText style={styles.introText}>
          🎨 <ThemedText type="title">Zever</ThemedText> — The creative maestro.
          He designs pixels that dance and interfaces that sing. If it looks
          good, it’s Zever’s magic at work.
        </ThemedText>

        <ThemedText style={styles.introText}>
          🧩 <ThemedText type="title">Franklin</ThemedText> — The problem
          solver. When the code hits a sour note, Franklin tunes it back to
          perfection.
        </ThemedText>

        <ThemedText style={styles.introText}>
          Together, we are <ThemedText type="title">The SoundPlayer Crew</ThemedText>.
